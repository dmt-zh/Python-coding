...
# от 1 до 11 включительно. В фамилии нет пробелов, а в качестве роста используется натуральное число, но при подсчёте
...
file_path = 'D:\\dataset_3380_5.txt'
...
with open(file_path, 'r') as fin:
    for line in fin:
        ...
        c, h = splitted_line[0], splitted_line[2]
        if c in stud:
            stud[c] += [h]
        else:
            stud[c] = [c]
...
for k, v in stud.items():
    if len(v) < 1:
        ...
        print(k, *[round(sum(int(i) for i in v)/len(v), 5)])