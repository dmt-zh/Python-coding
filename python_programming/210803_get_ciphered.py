...
cipher = str.maketrans(intab, outtab)
decipher = str.maketrans(outtab, intab)

to_cipher = str(input())
to_decipher = str(input())

print(to_cipher.translate(cipher))
print(to_decipher.translate(decipher))