...
# С объектами класса Player должна работать функция: bool(player) которая возвращает True, если число очков
# больше нуля, и False - в противном случае.

# С помощью команды:
# lst_in = list(map(str.strip, sys.stdin.readlines()))
# считываются строки из входного потока в список строк lst_in. Каждая строка записана в формате: "имя; возраст; очки"
...
lst_in = list(map(str.strip, sys.stdin.readlines()))
players = [Player(*map(str.strip, args.rsplit(';', 2))) for args in lst_in]
