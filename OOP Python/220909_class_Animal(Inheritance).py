...
# Сделаем такой пример. Объявите в программе базовый класс Animal (животное), объекты которого
# можно создать командой: an = Animal(name, old)
...
# метод get_info должен вернуть строку: "кот: 4, black, 2.25"
