...
# Вызовите метод is_triangle() из объекта tr и выведите результат на экран.
...
class TriangleChecker:
    ...
    def is_triangle(self):
        ...
        if any([type(i) not in [int, float] for i in sides]) or any([i <= 0 for i in sides]):
            return 1
        elif any([self.a + self.b < self.c, self.a + self.c < self.b, self.b + self.c < self.a]):
            return 2
        else:
            return 3
